...
class CampaignsMailingListsTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = $this->getTableLocator()->exists('CampaignsMailingLists') ? [] : ['className' => CampaignsMailingListsTable::class];
        $this->CampaignsMailingLists = $this->getTableLocator()->get('CampaignsMailingLists', $config);
    }
