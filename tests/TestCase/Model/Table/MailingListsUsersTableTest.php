...
class MailingListsUsersTableTest extends TestCase
{
    ...
    {
        parent::setUp();
        $config = $this->getTableLocator()->exists('MailingListsUsers') ? [] : ['className' => MailingListsUsersTable::class];
        $this->MailingListsUsers = $this->getTableLocator()->get('MailingListsUsers', $config);
    }
