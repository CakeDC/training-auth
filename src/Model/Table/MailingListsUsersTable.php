 ...
 *
 * @method \App\Model\Entity\MailingListsUser newEmptyEntity()
 * @method \App\Model\Entity\MailingListsUser newEntity(array $data, array $options = [])
 ...
 * @method \App\Model\Entity\MailingListsUser[] patchEntities(iterable $entities, array $data, array $options = [])
 ...
 * @method \App\Model\Entity\MailingListsUser[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\MailingListsUser[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \App\Model\Entity\MailingListsUser[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\MailingListsUser[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
 */
