 ...
 *
 * @method \App\Model\Entity\CampaignsMailingList newEmptyEntity()
 * @method \App\Model\Entity\CampaignsMailingList newEntity(array $data, array $options = [])
 ...
 * @method \App\Model\Entity\CampaignsMailingList[] patchEntities(iterable $entities, array $data, array $options = [])
 ...
 * @method \App\Model\Entity\CampaignsMailingList[]|\Cake\Datasource\ResultSetInterface|false saveMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\CampaignsMailingList[]|\Cake\Datasource\ResultSetInterface saveManyOrFail(iterable $entities, $options = [])
 * @method \App\Model\Entity\CampaignsMailingList[]|\Cake\Datasource\ResultSetInterface|false deleteMany(iterable $entities, $options = [])
 * @method \App\Model\Entity\CampaignsMailingList[]|\Cake\Datasource\ResultSetInterface deleteManyOrFail(iterable $entities, $options = [])
 */
class CampaignsMailingListsTable extends Table
{
    ...
    public function buildRules(RulesChecker $rules): RulesChecker
    {
        ...
        $rules->add($rules->existsIn(['mailing_list_id'], 'MailingLists'), ['errorField' => 'mailing_list_id']);
